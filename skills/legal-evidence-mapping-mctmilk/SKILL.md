...
author: mctmilk (via clawic/skillhub marketplace)
version: "2.0.0"
license: MIT
description: 将法条构成要件对应当事人需要证明的事实、举证责任分配和可用证据类型，生成完整的证据作战地图。当用户想"把法条翻译成证据清单"时使用。不要用于：案件全流程处理（走 workflow-orchestrator）、法律文书起草。
---
